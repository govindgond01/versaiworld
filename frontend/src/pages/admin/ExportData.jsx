...
const ExportData = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ CORRECT FILTERS AS PER USER MODEL
  ...
  // ✅ DYNAMIC CATEGORY OPTIONS FROM USER MODEL
  ...
  // ✅ DYNAMIC COURSE OPTIONS FROM USER MODEL
  const courseOptions = [
    { value: 'all', label: 'All Courses', icon: <FiBookOpen className="w-4 h-4" /> },
  ...
  // ✅ DEPARTMENT OPTIONS (ONLY FOR STAFF)
