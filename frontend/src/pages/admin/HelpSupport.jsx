      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Help & Support</h1>
        ...
        <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
          ...
          <input 
            ...
            className="w-full px-12 py-3 bg-white border border-gray-200 rounded-xl text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" 
          />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {quickActions.map((item, i) => (
            <button
              key={i}
              onClick={item.action}
              className={`bg-${item.color}-50 border border-${item.color}-200 rounded-xl p-5 text-center hover:shadow-md transition-all hover:scale-105 active:scale-95`}
            >
              <div className={`text-3xl text-${item.color}-600 mb-2`}>{item.icon}</div>
              <h3 className="font-semibold text-gray-900 text-sm mb-1">{item.label}</h3>
              <p className="text-xs text-gray-600 break-words">{item.desc}</p>
            </button>
          ))}
        </div>
        ...
        <div className="bg-white rounded-t-xl border border-gray-200 border-b-0">
          <div className="flex p-2 gap-1">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-medium transition-all flex-1 sm:flex-none justify-center ${
                activeTab === 'faq'
        ...
        <div className="bg-white rounded-b-xl border border-gray-200 border-t-0">
          ...
          {activeTab === 'faq' && (
            <div className="p-6">
              <h2 className="font-semibold text-base mb-4 flex items-center gap-2">
                <MdOutlineQuestionAnswer className="w-5 h-5 text-blue-600" /> 
              ...
              {filteredFaqs.length > 0 ? (
                  ...
                  {filteredFaqs.map((faq, i) => (
                    <div key={i} className="border border-gray-200 rounded-lg p-4 hover:border-blue-200 transition">
                      <div className="flex flex-col sm:flex-row sm:items-start gap-3">
                        ...
                        <span className={`px-2.5 py-1 text-xs font-medium rounded-full whitespace-nowrap self-start ${getCategoryColor(faq.cat)}`}>
                          {faq.cat}
                        </span>
                      </div>
                    </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-500">No FAQs found matching "{searchQuery}"</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'contact' && (
            <div className="p-6">
              <h2 className="font-semibold text-base mb-4 flex items-center gap-2">
                <MdContactSupport className="w-5 h-5 text-blue-600" /> 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="font-medium text-gray-900 text-sm">Support Hours</h3>
                  {[
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <a href="tel:+918619708196" className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                      <div className="p-2 bg-blue-100 rounded-lg text-blue-600">
                        <FiPhone className="w-4 h-4" />
                      </div>
                      <span className="text-sm text-gray-900">+91-8619708196</span>
                    </a>
                    
                    <a href="mailto:versaiacademy94@gmail.com" className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                      <div className="p-2 bg-blue-100 rounded-lg text-blue-600">
                        <FiMail className="w-4 h-4" />
                      </div>
                      <span className="text-sm text-gray-900 break-all">versaiacademy94@gmail.com</span>
                    </a>
                    
                    <a href="https://help.versai.edu" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                      <div className="p-2 bg-blue-100 rounded-lg text-blue-600">
                        <FiGlobe className="w-4 h-4" />
                      </div>
                      <span className="text-sm text-gray-900">help.versai.edu</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'ticket' && (
            <div className="p-6">
              <h2 className="font-semibold text-base mb-4 flex items-center gap-2">
                <MdOutlineSupportAgent className="w-5 h-5 text-blue-600" /> 
              ...
              {submitStatus === 'success' && (
                <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center gap-2 text-green-700">
                  ...
                  <span className="text-sm">Ticket submitted successfully! We'll get back to you soon.</span>
                </div>
              )}
              ...
              <form onSubmit={handleTicketSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input 
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" 
                  />
                  <input 
                    type="email" 
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input 
                    ...
                    required
                    className="flex-1 px-4 py-3 border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" 
                  />
                  <select 
                    value={ticketData.priority}
                    onChange={(e) => setTicketData({...ticketData, priority: e.target.value})}
                    className="w-full sm:w-32 px-4 py-3 border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 bg-white transition-all"
                  >
                ...
                <textarea 
                  ...
                  required
                  rows="5"
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm h-32 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" 
                />
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3">
                  <button 
                    ...
                    className="w-full sm:w-auto px-6 py-2.5 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition"
                  >
                    Clear
                  </button>
                  <button 
                    type="submit"
                    className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 flex items-center justify-center gap-2 transition"
                  >
                    Submit Ticket
                    <FiMail className="w-4 h-4" />
                  </button>
